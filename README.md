...
> A full-stack food ordering & restaurant management platform built with **Next.js 15** and **TypeScript**, powered by a DevOps pipeline using **Git, Jenkins, Maven/Gradle, Docker, Kubernetes, and Ansible**.
...
```bash
git clone https://github.com/DashEats/dasheats-tempo.git
cd dasheats-tempo
pnpm install
pnpm dev
```
